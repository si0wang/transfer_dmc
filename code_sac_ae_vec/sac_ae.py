...
from dynamics_model import RewardModel, DynamicsModel, RewardActionEncoder, DynamicsActionEncoder
...
class SacAeAgent(object):
    ...
    def __init__(
        ...
        # optimizers
        self.dynamics_model_optim = torch.optim.Adam(
            self.dynamics_model.parameters(), lr=dynamicsmodel_lr)

        self.reward_model_optim = torch.optim.Adam(
            self.reward_model.parameters(), lr=rewardmodel_lr)
